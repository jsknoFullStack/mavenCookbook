...
You should see messages similar to the following:
    ...
    INFO  [com.maven.jskno.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [com.maven.jskno.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
